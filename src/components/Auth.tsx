...
const Auth = () => {
    ...
    useEffect(() => {
        if(isLoginSuccess) {
            ...
            dispatch(setUser({ username: loginData.user.username, email: loginData.user.email, birthdate: loginData.user.birthdate, location: loginData.user.location, avatar: loginData.user.avatar, token: loginData.jwt }))
            navigate("/profile");
        }

        if(isRegisterSuccess) {
            toast.success("Success! Welcome to tend")
            dispatch(setUser({ username: registerData.user.username, email: registerData.user.email, birthdate: registerData.user.birthdate, location: registerData.user.location, avatar: registerData.user.avatar, token: registerData.jwt }));
            navigate("/profile");
        }
        ...
        /* <section>
            <div className='flex flex-row w-full items-center'>
                <div className='py-12 flex-1'>
                    <div className='flex items-center justify-center m-auto rounded-lg shadow-2xl overflow-hidden w-11/12'>
                        <div>
                            <video autoPlay loop muted>
                                <source src={require("../assets/logos/tend-Logo-pop.mp4")} type="video/mp4" />
                            </video>
