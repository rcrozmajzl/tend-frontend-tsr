                        ...
                        <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                            <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                <table className="min-w-full leading-normal">
                                    ...
                                    {isFetchNeedsSuccess && (
                                        <div>
                                        {fetchNeedsData!.map(need =>{
                                            switch(need.category) {
                                                case 'Energy & Synergy':
                                                    return <div className='need' key={need.id}>
                                                            <tr>
                                                ...
                                                case 'Communication & Boundaries':
                                                    return <div className='need' key={need.id}>
                                                            <tr>
                                                                ...
                                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                    <p className="text-gray-900 whitespace-no-wrap">
                                                                        I feel best with people who are comfortable being direct and unambiguous in their communication
                                                                    </p>
                                                                </td>
                                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                    <button>
                                                ...
                                                case 'Support Needs & Strengths':
                                                    return <div className='need' key={need.id}>
                                                            <tr>
                                                                ...
                                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                    <p className="text-gray-900 whitespace-no-wrap">
                                                                        Sensory accommodations - sound
                                                                    </p>
                                                                </td>
                                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                    <p className="text-gray-900 whitespace-no-wrap">
                                                                        I have unique support needs related to sensory processing of sound
                                                                    </p>
                                                                </td>
                                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                                    <button>
